...
public class App {
    ...
    public static void main(String[] args) throws Exception 
    {
        ...
        String[] nomesArray = armazenaNomes(listaFilmes);
        ...
        while (true) 
        {
            ...
            if (binarySearchString(nomesArray,nomePesquisa)) 
            {
    ...
    public static String[] armazenaNomes(ArrayList<Filme> lista) 
    {
        String[] res = new String[lista.size()];
        for (int i = 0; i < lista.size(); i++) 
        {
            res[i] = lista.get(i).getNome();
